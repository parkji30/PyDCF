...
plt.plot(bin_edges_ps, linear_fit(bin_edges_ps**2, *popt_linear), label='Linear Fit', linestyle="--")
plt.legend()
plt.show()
...
plt.plot(bin_edges_ps[:-1], gauss_function(bin_edges_ps[:-1],*popt_gauss), label="Gaussian Fit", linestyle="--")
plt.legend()
plt.show()
