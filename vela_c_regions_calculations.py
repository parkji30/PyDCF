...
os.chdir("/Users/a16472/Desktop/MDCF/testing/")
...
masking = np.load("velac_masking.npy")
...
corrected_cos_disp_sq = 1-(cos_disp_sq/(1-0.5*err_binned))
...
corrected_cos_disp = 1-cos_disp/(1-0.5*err_binned)

plt.figure(figsize = (12, 8))
plt.title("Linear Fit Arcmin")
plt.ylabel("1 - Cosdisp")
plt.xlabel("L (Arcmin)")
plt.plot(bin_edges_am[:-1], corrected_cos_disp, linestyle ="none", marker="X", label="Data Points")
